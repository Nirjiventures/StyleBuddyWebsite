...
class Sizes extends MY_Controller {
    ...
    public function index(){
        $this->getPermission('admin/sizes');
    ...
    public function add(){
        $this->getPermission('admin/sizes/add');
        ...
        $tbl_name = $this->tbl_name;
        if ($postData) {
            $this->form_validation->set_rules('size_name', 'size_name', 'required|trim');
    ...
    public function edit($id){
        $this->getPermission('admin/sizes/edit');
        $url1 = $this->uri->segment(1);
        $url2 = $this->uri->segment(2);
        $url3 = $this->uri->segment(3);
        $postData = $this->input->post();
    ...
    public function delete($id){
        $this->getPermission('admin/sizes/delete');
        $url1 = $this->uri->segment(1);
        $url2 = $this->uri->segment(2);
        $url3 = $this->uri->segment(3);
