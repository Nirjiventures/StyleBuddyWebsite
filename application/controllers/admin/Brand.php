...
class Brand extends MY_Controller {
...

    {
        ...
        $this->uploadPath = 'assets/images/brand/';
    ...
    public function index(){
        $this->getPermission('admin/brand');
    ...
    public function add(){ 
        ...
        $this->getPermission('admin/brand/add');
    ...
    public function edit($id=''){ 
        $this->getPermission('admin/brand/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/brand/delete');
        $url1 = $this->uri->segment(1);
