...
class Posts_type extends MY_Controller {
...

    {
        ...
        $this->tbl_name = 'posts_type';

         
        $this->uploadPath = 'assets/images/posts-type/';
    ...
    public function index(){
        $this->getPermission('admin/posts_type');
    ...
    public function add(){ 
        ...
        $this->getPermission('admin/posts_type/add'); 
    ...
    public function edit($id=''){ 
        $this->getPermission('admin/posts_type/edit'); 
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/posts_type/delete'); 
        $url1 = $this->uri->segment(1);
