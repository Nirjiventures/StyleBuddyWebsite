...
class Stylebuddy_works extends MY_Controller {
...

    {
        ...
        $this->tbl_name = 'stylebuddy_works';

         
        $this->uploadPath = 'assets/images/stylebuddy_works/';
    ...
    public function add(){ 
        ...
        $data['right_heading'] = 'Stylebuddy works List';
        ...
        if (!empty($postData)) {            
            ...
            if($this->form_validation->run()== TRUE){
                ...
                $multiImage = $this->uploadSingleImageOnly('image',$this->uploadPath);
