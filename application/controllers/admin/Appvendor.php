...
Class Appvendor extends MY_Controller {
	...
	public function index() {
        ...
        $tbl_name = 'vender';
        //$condition = " WHERE user_type = '2' AND (user_agent LIKE '%StyleBuddy%' OR user_agent LIKE '%okhttp%') ";
        //$condition = " WHERE user_type = '2' AND FIND_IN_SET('app',registration_on) ";
        
        $condition = " WHERE user_type = '2' AND (user_agent LIKE '%StyleBuddy%' OR user_agent LIKE '%okhttp%' OR FIND_IN_SET('app',registration_on)  ) ";
