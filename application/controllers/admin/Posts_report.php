...
Class Posts_report extends MY_Controller {
	...
	public function index() {
		$this->getPermission('admin/posts_report');
		$data = array(

            'rows' => $users,

            'title' => 'Posts Report Log List',

            'list_heading' => 'Posts Report Log list',
		...
		foreach ($post_list as $key => $value) {
			$r = $this->common_model->get_all_details('posts',array('id'=>$value->post_id))->row();
			$post_list[$key]->post = $r;
			$r = $this->common_model->get_all_details('vender',array('id'=>$r->post_admin_id))->row();
			$post_list[$key]->post_user = $r;
    ...
    public function delete($id){
    	$this->getPermission('admin/posts_report/delete');
