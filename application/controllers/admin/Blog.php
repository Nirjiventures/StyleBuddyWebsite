...
class Blog extends MY_Controller {
    ...
    {   $this->getPermission('admin/blog-category');
    ...
    {   $this->getPermission('admin/blog-category/add');
    ...
    {       $this->getPermission('admin/blog-category/edit');
    ...
    {   $this->getPermission('admin/blog-category/delete');
