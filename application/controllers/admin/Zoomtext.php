...
class Zoomtext extends MY_Controller {
    ...
    public function index(){
        $this->getPermission('admin/zoomtext');
    ...
    public function add(){
        $this->getPermission('admin/zoomtext/add');
    ...
    public function edit($id){
        $this->getPermission('admin/zoomtext/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/zoomtext/delete');
        $url1 = $this->uri->segment(1);
