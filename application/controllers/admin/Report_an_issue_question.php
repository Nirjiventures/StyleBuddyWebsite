...
class Report_an_issue_question extends MY_Controller {
    function __construct(){
        ...
        $this->tbl_name = 'report_an_issue_question';

         
        $this->uploadPath = 'assets/images/report_an_issue_question/';
    ...
    public function index(){
        $this->getPermission('admin/report_an_issue_question');
    ...
    public function add(){ 
        ...
        $this->getPermission('admin/report_an_issue_question/add');
    ...
    public function edit($id=''){ 
        $this->getPermission('admin/report_an_issue_question/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/report_an_issue_question/delete');
        $url1 = $this->uri->segment(1);
