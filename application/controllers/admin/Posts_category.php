...
class Posts_category extends MY_Controller {
    ...
    public function index(){
        $this->getPermission('admin/posts_category');
    ...
    public function add(){ 
        $this->getPermission('admin/posts_category/add');
        ...
        $data['right_heading'] = 'Post category';
    ...
    public function edit($id=''){ 
        $this->getPermission('admin/posts_category/edit');
        $url1 = $this->uri->segment(1);
        ...
        $data['right_heading'] = ' Post category List';
    ...
    public function delete($id){
        $this->getPermission('admin/posts_category/delete');
        $url1 = $this->uri->segment(1);
