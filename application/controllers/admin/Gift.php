...
class Gift extends MY_Controller {
...

	{
        ...
        $this->uploadPath = 'assets/images/gift/';
    ...
    public function index(){
        ...
        $this->load->view('admin/gift/list',$data);

    }

    public function add(){ 

        $this->getPermission('admin/gift/add');
    ...
    public function edit($id=''){ 
        $this->getPermission('admin/gift/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/gift/delete');
        $url1 = $this->uri->segment(1);
