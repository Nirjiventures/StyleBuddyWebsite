...
Class Appuser extends MY_Controller {
	...
	public function index() {
        ...
        //$condition = " WHERE user_type = '3' AND FIND_IN_SET('app',registration_on) ";
        $condition = " WHERE user_type = '3' AND (user_agent LIKE '%StyleBuddy%' OR user_agent LIKE '%okhttp%' OR FIND_IN_SET('app',registration_on)  ) ";
