...
class Offers extends MY_Controller {
...

	{
        ...
        $this->tbl_name = 'offers';

        $this->uploadPath = 'assets/images/offers/';
    ...
    public function index(){
        $this->getPermission('admin/offers');
        $table = $this->tbl_name;
    ...
    public function add(){ 
        ...
        $this->getPermission('admin/offers/add');
        ...
        $this->load->view('admin/offers/addedit',$data);

    }

    public function edit($id=''){ 
        $this->getPermission('admin/offers/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/offers/delete');
        $url1 = $this->uri->segment(1);
