...
class Faqs extends MY_Controller {
    function __construct(){
        ...
        $this->uploadPath = 'assets/images/faqs/';
    ...
    public function add(){ 
        ...
        $this->getPermission('admin/faqs/add');
        ...
        if (!empty($postData)) {            
            ...
            if($this->form_validation->run()== TRUE){
                ...
                $insert_data['cat_id']      = trim($this->input->post('cat_id'));
        ...
        $data['faqs_category'] = $list; 
        $this->load->view('admin/'.$url2.'/addedit',$data);

    }

    public function edit($id=''){ 
        $this->getPermission('admin/faqs/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/faqs/delete');
        $url1 = $this->uri->segment(1);
