...
class Homepageservices extends MY_Controller {
...

    {
        ...
        $this->tbl_name = 'home_page_services';

         
        $this->uploadPath = 'assets/images/home-page-services/';
    ...
    public function index(){
        $this->getPermission('admin/homepageservices');
    ...
    public function add(){ 
        ...
        $this->getPermission('admin/homepageservices/add'); 
        ...
        if (!empty($postData)) {            
            ...
            if($this->form_validation->run()== TRUE){
                ...
                $insert_data['display_name']      = trim($this->input->post('display_name'));
    ...
    public function edit($id=''){ 
        $this->getPermission('admin/homepageservices/edit'); 
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/homepageservices/delete'); 
        $url1 = $this->uri->segment(1);
    ...
    public function update_ui_order($ui_order='',$id='',$category=''){ 
