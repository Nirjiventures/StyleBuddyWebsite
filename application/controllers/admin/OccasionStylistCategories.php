...
class OccasionStylistCategories extends MY_Controller {
...

    {
        ...
        $this->tbl_name = 'occasion_stylist_category';

         
        $this->uploadPath = 'assets/images/stylist-category/';
    ...
    public function index(){
        $this->getPermission('admin/occasionStylistCategories');
        ...
        $this->load->view('admin/stylist-category/list',$data);

    }

    public function add(){ 
        $this->getPermission('admin/occasionStylistCategories/add');
        ...
        $data['right_heading'] = 'Occasion Stylist Category List';
        ...
        $this->load->view('admin/stylist-category/addedit',$data);

    }

    public function edit($id=''){ 
        $this->getPermission('admin/occasionStylistCategories/edit');
        $url1 = $this->uri->segment(1);
    ...
    public function delete($id){
        $this->getPermission('admin/occasionStylistCategories/delete');
        $url1 = $this->uri->segment(1);
