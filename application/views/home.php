...
<body>
	...
	<div align="center">
		<h2>Google authentication library </h2>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col s12 m6 offset-m3 l6 offset-l3">
				...
				<?php }else{?>
					<a href="<?=base_url()?>user_authentication/google_logout" class="waves-effect waves-light btn red"><i class="fa fa-google left"></i>Google logout</a>
				<?php }
				?>
