    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="best_coupn">
            ...
            <div class="row">
                <?php if ($couponRow) { if($this->uri->segment(1) == 'cart'){ ?>
...
<!-- Login for a free session popup start from here -->
<div class="modal" id="free_s_login">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            <!-- Modal body -->
            <div class="modal-body">
                <div class="free_sess_login">
                    <div class="lodd">
                        <img src="https://dndtestserver.com/stylebuddy-newsite2/beta2/assets/images/logo7.png">
                        <div class="col-sm-12 text-center">Login for a free session</div>
                    </div>
                    <div class="row align-items-center justify-content-center">
                        <div class="col-sm-5 d-none d-lg-block">
                            <div class="side-media">
                                <img src="https://dndtestserver.com/stylebuddy-newsite2/beta2/assets/images/book-session.png">
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="logoa_dadd">
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-lg-12">
                                        <p id="free_sess_msg" class="error-msg"></p>
                                        <div class="form_fm">
                                            <label class="pop-label">Email Id<sup>*</sup></label>
                                            <input type="text" id="FSessEmail" name="FSessEmail" value="" class="bxo form-control">
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form_fm">
                                                <label class="pop-label">Password<sup>*</sup></label>
                                                <input type="password" id="FSessPass" name="FSessPass" value="" class="bxo form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12 text-center">
                                                <div class="form_fm1">
                                                    <input type="submit" value="login" class="action_bt_2 " onclick="submitForm()">
                                                    <a href="<?=base_url('user/registration')?>" class="action_bt_2">Register</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal" id="free_s_message">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            ...
            <div class="modal-body">
                <div class="free_message">
                    ...
                    <input type="submit" value="Book your free session now!" class="action_bt_msg " onclick="submitForm1()">
                </div>
            </div>
        </div>
    </div>
...
<div class="modal" id="free_s_popup">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <!-- Modal Header -->
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            <!-- Modal body -->
            <div class="modal-body">
                <div class="free_sess_form">
                    <div class="lodd">
                        <img src="https://dndtestserver.com/stylebuddy-newsite2/beta2/assets/images/logo7.png">
                        <div class="col-sm-12 text-center">
                            <h3>Book your free session now! </h3>
                        </div>
                    </div>
                    <div class="row align-items-center justify-content-center">
                        <div class="col-sm-5 d-none d-lg-block">
                            <div class="side-media">
                                <img src="https://dndtestserver.com/stylebuddy-newsite2/beta2/assets/images/book-session-2.png">
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="logoa_dadd">
                                <div class="row row align-items-center justify-content-center">
                                    <p id="book_sess_now" class="error-msg"></p>
                                    <div class="col-lg-6">
                                        <div class="form_fm">
                                            <label class="pop-label">Full Name<sup>*</sup></label>
                                            <input type="text" id="freesess_name" name="freesess_name" value="<?php if(!empty($this->session->userdata('loginUser'))){ echo $this->session->userdata('loginUser'); } ?>" class="bxo form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form_fm">
                                            <label class="pop-label">Email Id<sup>*</sup></label>
                                            <input type="text" id="freesess_email" name="freesess_email" value="<?php if(!empty($this->session->userdata('email'))){ echo $this->session->userdata('email'); } ?>" class="bxo form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form_fm">
                                            <label class="pop-label">Mobile No.<sup>*</sup></label>
                                            <input type="text" id="freesess_mobile" name="freesess_mobile" value="<?php if(!empty($this->session->userdata('mobile'))){ echo $this->session->userdata('mobile'); } ?>" class="bxo form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form_fm">
                                            <select type="text" id="freesess_service" name="freesess_service" value="" class="bxo form-control form-select" >
                                                <option value=""> ---- Select Service ----</option>
                                                <option value="Quick Styling Consultation">Quick Styling Consultation</option>
                                                <option value="Personal Wardrobe Edit">Personal Wardrobe Edit</option>
                                                <option value="Personal Shopper">Personal Shopper</option>
                                                <option value="Enhance Your Confidence And Self-Image">Enhance Your Confidence And Self-Image</option>
                                                <option value="Discuss Your Fashion Needs For Free">Discuss Your Fashion Needs For Free</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form_fm">
                                            <label class="pop-label">Comments<sup>*</sup></label>
                                            <textarea type="text" id="freesess_comments" name="freesess_comments" value="" rows="5" class="bxo2 form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 text-center">
                                        <div class="form_fm1">
                                            <input type="submit" onclick="submitForm2()" value="Book your session now!" class="action_bt_2">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="modal" id="free_s_popup_message">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="javascript:window.location.reload()"></button>
            <!-- Modal body -->
            <div class="modal-body">
                <div class="free_message">
                    <img src="https://dndtestserver.com/stylebuddy-newsite2/beta2/assets/images/logo7.png">
                    <p><b>Thanks for your details. Our styling team will contact you soon.</b></p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Login for a free session popup end here -->