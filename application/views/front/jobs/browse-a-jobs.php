...
<section class="job-browse section mt-5">
	 				...
	 				<div class="mbl">
		 				<div class="row mbl-fliter">
		 					<div class="col-6 col-sm-6">
		 						<a href="" class="action_bt_2" data-bs-toggle="modal" data-bs-target="#myModal"><i class="fa fa-sliders" aria-hidden="true"></i> Categories</a>
		 					</div>
		 					<div class="col-6 col-sm-6 text-end">
		 						<a href="" class="action_bt_2" data-bs-toggle="modal" data-bs-target="#myModal2"><i class="fa fa-sliders" aria-hidden="true"></i> Location</a>
		 					</div>
		 				</div>
	 				</div>
		                    ...
		                    <div class="row align-items-center">
		                        ...
		                        <div class="col-lg-12 col-md-12 col-xs-12">
									<div class="job-details">
		                                <h3><?= $value['job_title']; ?> <span class="action_bt_2 fontfamily"><?= $value['job_type']; ?></span></h3>
		                                <div class="location"> 
											<?php if($value['city']){ ?> 
									...
									<div class="row m-0">
										...
										<div class="col-sm-9 p-0 text-end">
											<span class="action_bt4 ">View Details</span>
										</div>
									</div>
								</div>
							</div>
				      ...
				      <div class="modal-body">
				      	<div class="mbllist_filter">
					        <form name="filterForm1" id="filterForm1">
								...
								<a href="" class="action_bt_2">Submit</a>
							</form>
						</div>
				      </div>
