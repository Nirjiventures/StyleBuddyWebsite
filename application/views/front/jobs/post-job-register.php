				...
				<?php } ?>
					...
					<div class="col-sm-12">
						<div class="form-group boot_sp">
							...
							<input type="text"  name="fname"  id="fname" value="<?= set_value('fname') ?>" class="box_new">
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group boot_sp">
					...
					<div class="col-sm-12">
						<div class="form-group boot_sp">
							...
							<input type="text" id="mobile" name="mobile" value="<?= set_value('mobile') ?>" class="box_new">
						</div>
					</div>
					...
					<div class="col-sm-12">
						<div class="form-group boot_sp">
							...
							<input type="text" id="contact_person_name" name="contact_person_name" value="<?= set_value('contact_person_name') ?>" class="box_new">
						</div>
					</div>
					...
					<div class="col-sm-12">
						<div class="form-group boot_sp">
							...
							<select class="box_new" name="state" id="state" >
