						...
						<div class="row">
							<div class="col-sm-12">
								<div class="input-group">
								    <input type="text" class="form-control" name="expert" id="expert" autocomplete="off"  placeholder="Search by experts name..." required>
			...
			<div class="row mt-4">
				<div class="col-sm-12 mgt_tab">
					 <ul class="nav nav-pills justify-content-center" role="tablist">
					    ...
					    <li class="nav-item">
					      <a class="nav-link active" data-bs-toggle="tab" href="#menu1">Stylist</a>
					    </li>
					  </ul>
