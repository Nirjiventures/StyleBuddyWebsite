	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-12 text-center mobile_sp">
				...
				<h1 class="h1_title"><span>FASHIONGRAM</span></h1>
		            ...
		            <div class="row m-0 justify-content-center">
        		        ...
        		        <?php 	if(!empty($venders)) {?>
        		        	...
        		        	<?php  	foreach($venders as $vender) { ?>
        		                    	...
        		                    	<?php $url =  base_url('stylist-zone/fashiongram-detail/').base64_encode($vender->id).'/'.strtolower($vender->fname.'-'.$vender->lname.'-'.str_replace(' ', '-', $vender->area_expertiseRow->name).'-in-'.str_replace(' ', '-', $vender->city_name)) ?>
        				    			...
        				    			<div class="stylish_feed">
        				    				...
        				    				<div class="thumb-part">
        				    				    ...
        				    				    <div class="slider_part">
        				    				            <?php foreach($vender->portfolioArray as $k=>$v){ ?>
    											      	    <?php 
	    											      	    if($v->image && $i==0){   
            										    	...
            										    	<div class="small-container">
            											      	...
            											      	<div id="small-img-roll">
            											      	    ...
            											      	    <?php foreach($vender->portfolioArray as $k=>$v){ ?>
                											      	    ...
                											      	    <?php if($v->image){ ?>
                											      	    	<?php  if (file_exists($image_path = FCPATH . 'assets/images/story/' . $v->image)) { ?>
																			    <img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"  src="<?= base_url('assets/images/story/'.$v->image) ?>" class="show-small-img show-small-img-fashion" style="border: 1px solid rgb(149, 27, 37); padding: 2px;" alt="now">
																			<?php  } else { ?>
																			    <img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"  src="<?= base_url('assets/images/stylist/no-image.jpg') ?>" class="show-small-img show-small-img-fashion" style="border: 1px solid rgb(149, 27, 37); padding: 2px;" alt="now">
																			<?php  } ?>
        		        	        ...
        		        	        <div class="col-sm-4">
        				    			...
        				    			<div class="stylish_feed">
        				    				...
        				    				<div class="thumb-part">
        				    				    ...
        				    				    <a  href="<?= $url ?>" class="vw-btn"><i class="fa fa-eye" aria-hidden="true"></i><?=$vender->count_view;?></a>       
