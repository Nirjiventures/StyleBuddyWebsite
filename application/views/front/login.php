						...
						<div class="login_form jogi_log">
							...
							<div class="col-sm-12 mb-3">
								...
								<div class="logo_p ">
									...
									<?php  if($segment2 == 'userlogin'){ ?>

										<div class="col-12  sign_into"><b><?php echo ($seoData->content);?></b></div>

										<a target="_blank" href="<?=base_url('login/stylistlogin')?>" class="login_as">Login as a Stylist here</a>

									<?php  }else{?>

										<div class="col-12  sign_into"><b><?php echo ($seoData->content);?></b></div>

										<a target="_blank" href="<?=base_url('login/userlogin')?>" class="login_as"></a>
							...
							<div class="fg_gp">
						 	...
						 	<div class="row m-0">
								...
								<div class="col-6 text-center  mt-3 paddright">

									<?php  if($segment2 == 'userlogin'){ ?>

										<a href="<?=base_url('user/registration')?>" class="action_bt4 w100 font16">Register</a>

									<?php  }else{?>

										<a href="<?=base_url('stylist-zone/registration')?>" class="action_bt4 w100 font16">Register</a>
