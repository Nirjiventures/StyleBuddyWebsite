		...
		<div class="rightbar">
			<div class="row">
				...
				<div class="col-sm-4 text-end">
					<a href="<?= base_url('stylist-zone/manage-tags') ?>" class="btn btn-success add_pro"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a> 
				</div>
			</div>
			
			<hr>
		        <?= form_open_multipart('stylist-zone/add-tags') ?>	
			<div class="row mt-5">
				...
				<div class="col-sm-12 mt-3">
				         <div class="form-group boot_sp">
							<input type="text" name="tag" id="tag" value="<?= set_value('tag'); ?>" placeholder="Enter Your #Tags" class="form-control box_in3">
				...
				<div class="col-sm-12 text-center">
					<input type="submit" value="Add #Tag"  class="btc">
				</div>
