...
<div class="main">
	<div class="container">
		<div class="col-sm-12">
			<div class="row m-0">
				<div class="col-sm-12">
					<div class="rightbar profile_fm">
						<div class="row">
							<div class="col-sm-8"><h2>Post Jobs</h2></div>
							<div class="col-sm-4 text-end">
								<a href="<?=base_url('stylist-zone/dashboard')?>" class="btn btn-primary add_pro"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
								&nbsp; - &nbsp; 
								<a href="<?=base_url('vendor/managejobs')?>" class="btn btn-success add_pro"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back</a>
							</div>
							<div class="col-sm-12">
