				...
				<div class="rightbar">
					<div class="row">
						...
						<div class="col-sm-4 text-end">
							<a href="<?= base_url('boutiques/manageProducts') ?>" class="btn btn-success add_pro"> Manage Products</a>
						</div>
						<div class="col-sm-12">
					...
					<div class="row mt-5">
						<div class="col-sm-6">
							<div class="form-group boot_sp">
								<input type="text" id="product_name" name="product_name" value="<?php if(set_value('product_name')) { echo set_value('product_name');} else { echo (!empty($products->product_name))?$products->product_name:'';  } ?>" class="form-control box_in3">
...
<script type="text/javascript">
	function delete_image(display,id,img,path,column,table,controller) {
		...
		if (confirm(text) == true) {
			$.ajax({
				type: 'GET',
				url: '<?=base_url()?>'+controller+'/deleteProductImages',	
