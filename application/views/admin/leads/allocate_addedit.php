      ...
      <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-3 mr-3 ">
               ...
               <li class="breadcrumb-item "> <a href="<?=base_url($url1.'/'.$url2.'/'.$url3)?>" class="text-decoration-none">Leads</a></li>
         ...
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('',['id'=>'sliderfrmm']);?>
               <div class="row">
                  ...
                  <div class="col-md-4 mbc">
                     <label for="Image Alt Description" class="form-label">Query<span class="text-danger"></span></label>
                  ...
                  <div class="col-md-4 mbc">
                      <label for="Status" class="form-label">Status <span class="text-danger">*</span></label>
                           ...
                           <select class="form-control" name="status" id="status">
                              ...
                              <option value="1" <?= ($record_detail->status == 1)?'selected':'' ?> > Completed</option>
                              <option value="0" <?= ($record_detail->status == 0)?'selected':'' ?> > Pending</option>
                           </select>
                  ...
                  <div class="col-sm-12 mbc">
                     <label for="Image Alt Description" class=" col-form-label">Message</label>
               ...
               <div class="col-md-12 text-center">
                  <div class="form-group">
                     ...
                     <a href="<?=base_url($url1.'/'.$url2.'/allocate')?>" class="btn btn-secondary mt-4">Go Back</a>
                  </div>
               </div>
