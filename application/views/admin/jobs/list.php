						...
						<?php  if(!empty($list)) { ?>
								...
								<?php  foreach($list as $row) { ?>
									...
									<tr style="<?=$style;?>">
										...
										<td class=''><?php echo ucwords($row->job_title); ?></td>

                                        <td class=''><?php echo ucwords($row->job_location); ?></td>

                                        <td class=''><?php echo ucwords($row->city); ?></td>

                                        <td class=''><?php echo ucwords($row->company); ?></td>
