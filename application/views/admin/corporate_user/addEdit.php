...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-3">
            ...
            <a href="<?php echo base_url($url1.'/'.$url2) ;?>" class="btn btn-primary float-right "><i class="fa fa-bars" aria-hidden="true"></i> Service </a>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="domain_id" id="domain_id" required>
                            ...
                            <?php foreach ($corporate_domain as $key => $value): ?>
                               <?php if($value->id == $datas->domain_id){$sel='selected';}else{$sel='';} ?> 
