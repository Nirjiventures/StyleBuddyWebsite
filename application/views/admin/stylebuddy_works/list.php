								...
								<?php  foreach($list as $row) { ?>
									...
									<tr style="<?=$style;?>">
                                        ...
                                        <td>
                                            ...
                                            <a onclick="update_ui_order('ui_order<?= $row->id?>',<?= $row->id?>,'<?= $url1?>')" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
                                        </td>
                                        <td>
                                            <button type="button" id="<?= $row->id; ?>" class="status_checks btn btn-sm  <?= ($row->status == 1)?"btn-primary":"btn-danger"; ?> ">
