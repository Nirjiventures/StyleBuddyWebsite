                ...
                <div class="row">
                  ...
                  <input type="hidden" name="id" value="<?= $record_detail['id']; ?>">
                     ...
                     <div class="col-sm-12">
                        ...
                        <label for="Image Alt Description" class=" col-form-label">Display Name on UI</label>

                        <input type="text" id="display_name" name="display_name" value="<?= $record_detail['display_name'] ?>" class="form-control ">
                           ...
                           <?php   $k = 0;foreach($galleryes as $gallery){ $k++; ?>
                              ...
                              <?php   if(!empty($gallery)){  ?> 
                                 ...
                                 <span class="" id="<?=$k.'__gal_image_s'?>">
                                    ...
                                    <a class="cross_image" onclick="delete_image('<?=$k.'__gal_image_s'?>',<?= $record_detail['id'] ?>,'image','assets/<?=$url2?>/','<?=$gallery?>','posts_type','<?=$url2?>')">X</a>

                                    <img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"   class="cross_img" src="<?=trim(base_url().'assets/images/posts-type/'.$gallery);?>" alt="">
