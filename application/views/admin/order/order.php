...
<div class="container">
    <div class="row mt-3">
        ...
        <div class="col-sm-6">
	      	<a href="<?= base_url('admin/Vender/userOrderExport');?>" class="btn float-right btn-primary text-white mb-3">Export Data</a>
	    </div>
	</div>
	<div class="row">
				 ...
				 ?>
						...
						<tr>
						   ...
						   <td><?= $value->order_id ?></td>
							...
							<td><a href="<?= base_url('admin/orders/orderDetails/').$value->id ?>" class="btn btn-success">View</a></td>
