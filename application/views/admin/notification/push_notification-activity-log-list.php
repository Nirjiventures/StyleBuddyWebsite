                        ...
                        <tr class="even"  data-val="<?=$row->id?>">
            				...
            				<?php if($this->session->userdata('admin_id') == 1 || in_array($url1."/".$url2.'/delete',$permission)){ ?>
								<td style="width: 100px;!important">
									<a href="<?php echo base_url($url1.'/'.$url2.'/delete/').$row->id;?>" class="btn btn-danger" data-record-id="<?php echo $row->id ?>" data-record-title="<?php echo $row->title ?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
								</td>
							<?php } ?>
