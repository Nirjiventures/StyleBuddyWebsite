      ...
      <div class="col-md-12 mt-5 form-main">
         <div class="card  form-card">
                 ...
                 <div class="col-md-6 mt-4">
                  ...
                  <div class="col-sm-6 mt-4">
                     <div class="row">
                         ...
                         <?php if($datas->slider_image ){?>
                           <div class="col-md-3 mt-4">
                              <?php $img =  'assets/images/no-image.jpg';?>
                              <?php if(!empty($datas->slider_image))  {?>
                                 <?php 
                                    $img1 =  'assets/images/slider/'.$datas->slider_image; 
                                    if (file_exists($img1)) {
                                         $img = $img1;
                                    }
                                 ?>
            ...
            <div class="col-sm-12 text-center">
               ...
               <a href="<?php echo base_url('admin/shopslider') ;?>" class="btn btn-secondary mt-2">Go Back</a>
            </div>
