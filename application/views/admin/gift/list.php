						...
						<?php  if(!empty($list)) { ?>
								...
								<?php  foreach($list as $row) { ?>
									...
									<tr style="<?=$style;?>">
                                        ...
                                        <td class=''><?php echo ucwords($row->gift_code_price); ?></td>

                                        <!-- <td class=''><?php echo ucwords($row->gift_code); ?></td>

                                        <td class=''><?php echo ucwords($row->gift_code_limit); ?></td>

                                        <td class=''><?php echo ucwords($row->gift_code_limit_avail); ?></td>

                                        <td class=''><?php echo ucwords($row->gift_code_limit_used); ?></td>
