      ...
      <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-3 mr-3 ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Our Services Update Form</li>
            </ol>
         </nav>
      </div>
   </div>
      ...
      <div class="col-md-12 mt-5 form-main">
         <div class="card  form-card">
            ...
            <div class="row mt-4 mb-2">
                ...
                <div class="col-md-12  mt-4">
                    <label for="Image Alt Description" class="form-label">Section 2</label>
                      <input type="text" name="section2" id="section2" class="form-control" value="<?= set_value('section2',$datas->section2); ?>" placeholder="section 2 Title">
                    <?php echo form_error('section2','<span class="text-danger mt-1">','</span>') ;?>
                </div>
                <div class="col-md-6  mt-4">
                    <label for="Image Alt Description" class="form-label">Left Section 2</label>
                ...
                <div class="col-md-6  mt-4">
                    <label for="Image Alt Description" class="form-label">Right Section 2</label>
                ...
                <div class="col-md-12  mt-4">
                    <label for="Image Alt Description" class="form-label">Bottom Content</label>
            ...
            <div class="col-12 text-center">
               ...
               <a href="<?php echo base_url('admin/our-services') ;?>" class="btn btn-secondary mt-2">Go Back</a>
            </div>
            <?php echo form_close();?>
         </div>
      </div>
