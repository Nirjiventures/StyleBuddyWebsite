   ...
   <div class="row">
      <div class="col-md-12 mt-5 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/update-fashion-consulting-services',['id'=>'sliderfrmm']);?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <label for="Image Alt Description" class="form-label">Fashion Service Name<span class="text-danger">*</span></label>
                      <select name="service_id" class="form-control" id="form-control" required>
                          ...
                          <?php if($services) { foreach($services as $data) { ?>
                            <option value="<?= $data->id ?>" <?= ($data->id == $datas->service_id)?'selected':'' ?> ><?= $data->title ?></option>
                          <?php }} ?>    
                      </select>
               ...
               <div class="col-md-2 mt-3">
                   <img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"  src="<?= base_url('assets/images/services/').$datas->image ?>" style="width:75px; height:75px" class="img-thumbnail">
               </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="hidden" name="id" value="<?= $datas->id ?>"><input type="hidden" name="old_image" value="<?= $datas->image ?>">
               </div>

               <div class="col-md-4">
                 <label for="Image Alt Description" class="form-label">Service Price<span class="text-danger">*</span></label>
                 <input type="text" name="price" id="price" value="<?= $datas->price ?>" class="form-control"  placeholder="Price varies OR 1,000">
               </div>

                <div class="col-md-4">
                 <label for="Image Alt Description" class="form-label">Service Time (in Hour) <span class="text-danger">*</span></label>
                  <input type="number" name="time" id="time" min="1" value="<?= $datas->time ?>" class="form-control" placeholder="Service Time">
               </div>
               ...
               <div class="col-sm-4">
                     <label for="Status" class="form-label">Status <span class="text-danger">*</span></label>
                        ...
                        <select class="form-control" name="status" id="status">
                           ...
                           <option value="0" <?= ($datas->status == 0)?'selected':'' ?> > Inctive</option>
                        </select>
            ...
            <div class="col-sm-12 text-center">
               ...
               <a href="<?php echo base_url('admin/fashion-consulting-services') ;?>" class="btn btn-secondary mt-2">Go Back</a>
            </div>
            <?php echo form_close();?>
         </div>
      </div>
