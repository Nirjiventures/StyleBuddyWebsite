      ...
      <div class="col-md-12 mt-5 form-main">
         <div class="card  form-card">
            <div id="success_message"></div>
             ...
             <?php echo form_open_multipart('admin/add-stylist-expertise-interests',['id'=>'sliderfrmm']);?>
            
            <div class="row">
                <div class="col-md-4">
                    <label for="Image Alt Description" class="form-label">Expertise / Interests Name <span class="text-danger">*</span></label>
                      <input type="text" name="name" id="name" class="form-control" value="<?= set_value('name'); ?>" placeholder="Expertise / Interests Service Name">
