      ...
      <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-3 mr-3 ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Personal Stylist Location Update Form</li>
            </ol>
         </nav>
      </div>
   </div>
   ...
   <div class="row">
      <div class="col-md-12 mt-5 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/update-personal-stylist',['id'=>'sliderfrmm']);?>
            
            <div class="row">
                <div class="col-md-6">
                     <label for="Image Alt Description" class="form-label">Stylist Location ( Page Title) <span class="text-danger">*</span></label>
                    <input type="text" name="title" id="title" class="form-control" value="<?= $datas->title ?>" required>
               ...
               <div class="col-md-3">
                ...
                <div class="col-md-3">
                 ...
                 <input type="file" name="last_image" id="last_image" class="form-control" title="Upload Main Image" >
                 <span class="text-center text-danger mb-2" id="errid"> <?php  echo $this->session->flashdata('imgerror');?></span>
               </div>
            </div>
             <div class="row mt-4">
                <div class="col-md-12">
                    <label for="Image Alt Description" class="form-label">Top Content<span class="text-danger">*</span></label>
                     <textarea class="form-control" name="top_content"  id="editor" required><?= $datas->top_content ?></textarea>
             ...
             <div class="row mt-4">
                <div class="col-md-6">
                    <label for="Image Alt Description" class="form-label">University Students<span class="text-danger">*</span></label>
                     <textarea class="form-control border border-dark"rows="5"  name="col_1_data"  id="editor1" rows="5" required><?= $datas->col_1_data ?></textarea>
               ...
               <div class="col-md-6 ">
                    <label for="Image Alt Description" class="form-label">Office Professionals<span class="text-danger">*</span></label>
                     <textarea class="form-control border border-dark"rows="5" name="col_2_data"  id="editor2" required><?= $datas->col_2_data ?></textarea>
               ...
               <div class="col-md-6 mt-4">
                    <label for="Image Alt Description" class="form-label">Entrepreneurs & Business Owners<span class="text-danger">*</span></label>
                     <textarea class="form-control border border-dark"rows="5" name="col_3_data"  id="editor3" required><?= $datas->col_3_data ?></textarea>
               ...
               <div class="col-md-6 mt-4">
                    <label for="Image Alt Description" class="form-label">Brides and Grooms<span class="text-danger">*</span></label>
                     <textarea class="form-control border border-dark"rows="5" name="col_4_data"  id="editor4" required><?= $datas->col_4_data ?></textarea>
               ...
               <div class="col-md-6 mt-4">
                    <label for="Image Alt Description" class="form-label">Homemakers<span class="text-danger">*</span></label>
                     <textarea class="form-control border border-dark"rows="5" name="col_5_data"  id="editor5" required><?= $datas->col_5_data ?></textarea>
               ...
               <div class="col-md-6 mt-4">
                    <label for="Image Alt Description" class="form-label">Kids<span class="text-danger">*</span></label>
                     <textarea class="form-control border border-dark"rows="5" name="col_6_data"  id="editor6" required><?= $datas->col_6_data ?></textarea>
             ...
             <div class="row mt-4">
                <div class="col-md-12">
                    <label for="Image Alt Description" class="form-label">Last Content<span class="text-danger">*</span></label>
                     <textarea class="form-control" name="last_content"  id="last_content"><?= $datas->last_content ?></textarea>
                     <script>CKEDITOR.replace('last_content', {height:250});</script>
                    ...
                    <input type="hidden" name="old_last_image" value="<?= $datas->last_image ?>">
               </div>
            </div>
