			...
			<table class="table table-bordered text-center table-hover shadow-lg" id="example">
				...
				<tbody>
					...
					<tr>
						...
						<td class=''><img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"  src="<?= base_url('assets/images/testimonial/').$data->image ?>" style="width:50px; height:50px;" clas="img-fluid"> </td>
    ...
    $(document).on('click','.status_checks',function() {
        ...
        var newstatus = (status=='0')? '1':'0';
         if(confirm("Are you sure to "+ msg)) {
                  $.ajax({
                  type:"POST",
                  url: '<?= base_url('admin/update_testimonial_status'); ?>', 
