               ...
               <div class="row">
                  ...
                  <div class="col-md-4 mbc">
                       <label for="Image Alt Description" class="form-label">First Name<span class="text-danger"></span></label>
                         <input type="text" name="fname" id="fname" class="form-control" value="<?= set_value('fname',$record_detail->name ); ?>" placeholder="First Name">
                  </div>
                  ...
                  <div class="col-md-4 mbc">
                        ...
                        <input type="text" name="mobile" id="mobile" class="form-control" value="<?= set_value('mobile',$record_detail->phone ); ?>" placeholder="Mobile">
                  </div>
                  <div class="col-md-4 mbc">
                  ...
                  <div class="col-md-4 mbc">
                        ...
                        <input type="hidden" name="stylist_id"  id="stylist_id" value="<?=$record_detail->vendor_id; ?>">
                  </div>
                  <div class="col-md-4 mbc">
                     ...
                     <select id="allocated" name="allocated" class="form-control" >
                        <?php foreach ($venderList as $key => $value) {  ?>
                           <?php 
                              ...
                              if(!$record_detail->allocated_id){$allocated_id=$record_detail->vendor_id;}
                           ?>
