                ...
                <div class="row">
                  ...
                  <input type="hidden" name="id" value="<?= $record_detail['id']; ?>">
                     ...
                     <div class="col-sm-12">
                        ...
                        <label for="Image Alt Description" class=" col-form-label">Category</label>
                        <select class="form-control" name="cat_id" id="cat_id" required>
                           <option value="">Select Category</option>
                           <?php foreach ($faqs_category as $key => $value) { if($record_detail['cat_id'] == $value['id']){$sel = 'selected';}else{$sel='';}?>
                           ...
                           <?php   $k = 0;foreach($galleryes as $gallery){ $k++; ?>
                              ...
                              <?php   if(!empty($gallery)){  ?> 
                                 ...
                                 <span class="" id="<?=$k.'__gal_image_s'?>">
                                    ...
                                    <a class="cross_image" onclick="delete_image('<?=$k.'__gal_image_s'?>',<?= $record_detail['id'] ?>,'image','assets/images/faqs/','<?=$gallery?>','','<?=$url2?>')">X</a>

                                    <img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"   class="cross_img" src="<?=trim(base_url().'assets/images/faqs/'.$gallery);?>" alt="">
