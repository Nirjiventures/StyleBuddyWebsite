               ...
               <div class="row">
                     <div class="col-sm-8">
                        <div class="row">
                           <div class="col-sm-6">
                              ...
                              <input type="text" name="fname" id="fname" class="form-control" value="<?= set_value('fname',$datas->fname); ?>">
                          ...
                          <div class="col-sm-6">
                              ...
                              <input type="text" name="lname" id="lname" class="form-control" value="<?= set_value('lname',$datas->lname); ?>">
                           ...
                           <div class="col-sm-6">
                              ...
                              <input type="email" name="email" id="email" class="form-control" value="<?= set_value('email',$datas->email); ?>">
                           ...
                           <div class="col-sm-6">
                              ...
                              <input type="text" name="designation" id="designation" class="form-control" value="<?= set_value('designation',$datas->designation); ?>">
                           ...
                           <div class="col-sm-6">
                              ...
                              <input type="text" name="experience" id="experience" class="form-control" value="<?= set_value('experience',$datas->experience); ?>">
                              <span id="designationErr"></span>
                              <?php echo form_error('designation','<span class="text-danger mt-1">','</span>') ;?>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-12">
                        ...
                        <input type="text" name="address" id="address" class="form-control" value="<?= set_value('address',$datas->address); ?>">
                     ...
                     <div class="col-sm-12">
                           ...
                           <textarea type="text" id="editor1" name="about" value="" class="form-control box_in2"><?= set_value('about',$datas->about); ?></textarea>
                     ...
                     <div class="col-sm-12">
                           ...
                           <textarea type="text" id="editor2" name="more_about" value="" class="form-control box_in2"><?= set_value('more_about',$datas->more_about); ?></textarea>
