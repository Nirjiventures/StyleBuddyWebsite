         ...
         <div class="card  form-card">
            ...
            <div class="row">
               <div class="col-md-4">
                  ...
                  <input type="text" name="name" id="name" class="form-control" value="<?= set_value('name', $datas->name); ?>" placeholder="Add name">
                  <?php echo form_error('name','<span class="text-danger mt-1">','</span>') ;?>
               </div>
               <div class="col-md-4">
                  <label for="Image Alt Description" class="form-label">Code <span class="text-danger">*</span></label>
                  <input type="color" required name="code" id="code" class="form-control" value="<?= set_value('code', $datas->code); ?>" placeholder="Add code">
                  <?php echo form_error('code','<span class="text-danger mt-1">','</span>') ;?>
               </div>
               <div class="col-md-4">
