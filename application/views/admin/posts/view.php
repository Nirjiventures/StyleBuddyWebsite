                ...
                <div class="row">
                  ...
                  <input type="hidden" name="id" value="<?= $record_detail['id']; ?>">
                     ...
                     <div class="col-sm-12">
                        ...
                        <input type="text" id="title" name="title" value="<?= $record_detail['title'] ?>" class="form-control" readonly>
                     ...
                     <div class="col-sm-12">
                        ...
                        <label for="Image Alt Description" class=" col-form-label">Post Type</label>
                           ...
                           <?php foreach ($posts_type as $key => $value): ?>
                                ...
                                <?php if ($value['slug'] == $record_detail['post_type']){ ?>
                                    <input type="text" id="title" name="title" value="<?=$value['name']?>" class="form-control" readonly>
                                <?php } ?>
                           <?php endforeach ?>
                     ...
                     <div class="col-sm-12">
                        ...
                        <label for="Image Alt Description" class=" col-form-label">Post Category</label>
                            ...
                            <?php foreach ($posts_category as $key => $value): ?>
                                <?php if ($value['slug'] == $record_detail['post_category']){ ?>
                                    <input type="text" id="title" name="title" value="<?=$value['name']?>" class="form-control" readonly>
                                <?php } ?>
                            <?php endforeach ?>
                     ...
                     <div class="col-sm-12">
                        ...
                        <textarea required id="description" name="description" class="form-control" readonly><?= $record_detail['description'] ?></textarea>
                        

                     </div>
                     <div class="col-sm-12">

                        <label for="Image Alt Description" class=" col-form-label">Media</label>
                      </div>
