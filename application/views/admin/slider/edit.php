         ...
         <div class="card  form-card">
            ...
            <div class="row">
               ...
               <div class="form-group boot_sp">
                  <label class="col-form-label" for="Price">Description<span class="text-danger">*</span></label>
                  <textarea class="form-control box_in2" id="editor3" name="sub_title" row="5"><?= set_value("sub_title",$datas->sub_title)?></textarea>
                  <?php echo form_error('sub_title','<span class="text-danger mt-1">','</span>');?>
               </div>
               </div>
               <div class="col-md-6">
               <div class="form-group boot_sp">
                  <label class="col-form-label" for="Price">Description 2<span class="text-danger">*</span></label>
                  <textarea class="form-control box_in2" name="sub_title2"><?= set_value("sub_title2",$datas->sub_title2) ?></textarea>
