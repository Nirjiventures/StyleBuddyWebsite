            ...
            <table class="table table-bordered text-center table-hover shadow-lg" id="example">				
				...
				<tbody>
					...
					<tr>
						...
						<td class='text-left'><p class="pc_name2"><?php echo ucwords($data->phone); ?></p></td>
						...
						<td class=''>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body c_lead">
                                                    <table class="table table-bordered text-left table-hover shadow-lg">
                                                        <tr><td>Phone:</td><td><?php echo ucwords($data->phone); ?></td></tr>
                            ...
                            <?php if($this->session->userdata('admin_id') == 1 || in_array('admin/Dashboard/askQuoteDelete/',$permission)){ ?>        
    					   		<a href="<?php echo base_url('admin/Dashboard/askQuoteDelete/').$data->id;?>" class="btn btn-danger"><i class="fa fa-trash  fa-lg" aria-hidden="true"></i></a>
    						<?php } ?>
						</td>
					</tr> 
				   <?php $num++;  } } else {?>
