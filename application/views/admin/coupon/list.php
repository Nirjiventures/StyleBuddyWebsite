				...
				<table class="table table-bordered text-center table-hover shadow-lg" id="example">
					...
					<thead class="text-white bg-primary">
						...
						<tr>
                            ...
                            <th class=''>Used Limit/User</th>



                            <!--<th class=''>Avail Limit</th>



                            <th class=''>Used Limit</th>-->
                            ...
                            <th class=''>Display Status<br/> on UI</th>
                            <th class=''>Status</th>
						...
						<?php  if(!empty($list)) { ?>
								...
								<?php  foreach($list as $row) { ?>
									...
									<tr style="<?=$style;?>">
                                        ...
                                        <td class=''><?php echo ucwords($row->coupon_code_price); ?></td>
                                        ...
                                        <td class=''><?php echo ucwords($row->coupon_code_limit); ?></td>



                                        <!-- <td class=''><?php echo ucwords($row->coupon_code_limit_avail); ?></td>



                                        <td class=''><?php echo ucwords($row->coupon_code_limit_used); ?></td>-->



                                        <!-- <td class=''><?php echo ucwords($row->min_price); ?></td>



                                        <td class=''><?php echo ucwords($row->max_price); ?></td> -->



                                        <td class=''><?php echo ucwords($row->start_date); ?></td>



                                        <td class=''><?php echo ucwords($row->end_date); ?></td>


                                        <?php $cls = '';if($this->session->userdata('admin_id') == 1 || in_array($url1."/".$url2.'/edit',$permission)){ $cls='display_status';}?>
                                        <td>
                                           <button type="button" id="<?= $row->id; ?>" class="<?=$cls?> btn btn-sm  <?= ($row->display_status == 1)?"btn-primary":"btn-danger"; ?> ">
                                           <?= ($row->display_status == 1)?"Show":"Hide"; ?>
                                           </button>
                                        </td>
    ...
    $(document).on('click','.display_status',function() {
            ...
            var newstatus = (status=='0')? '1':'0';
             ...
             if(confirm("Are you sure to "+ msg)) {
                      ...
                      url: "<?= base_url('admin/coupon/display_statusUpdate'); ?>", 
