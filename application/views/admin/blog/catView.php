...
<div class="container">
	<div class="row">
		<div class="col-md-12 mt-3">
			...
			<a href="<?php echo base_url('admin/add-blog-category') ;?>" class="btn btn-primary float-right "><i class="fa fa-plus" aria-hidden="true"></i> Add New Category</a>
			...
			<table class="table table-bordered text-center table-hover shadow-lg">
				...
				<tbody>
					...
					<tr>
						...
						<!--<td class=''><img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"  src="<?= base_url('upload/assets/images/').$data->cat_image ?>" style="width:60px; height:60px;" clas="img-thumbnail"> </td>-->
                  ...
                  <td><button type="button" id="<?= $data->id; ?>" class="<?=$cls?> btn btn-sm mt-1 <?= ($data->status == 1)?"btn-primary":"btn-danger"; ?> ">
                       ...
                       <td class=''>
                           ...
                           <a class="btn btn-primary" href="<?php echo base_url('admin/edit-blog-category/').$data->id;?>"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
                          <?php }?>
                          <?php if($this->session->userdata('admin_id') == 1 || in_array($url1.'/'.$url2.'/delete',$permission)){ ?>
                           <a class="btn btn-danger" href="<?php echo base_url('admin/delete-blog-category/').$data->id;?>"><i class="fa fa-trash fa-lg" aria-hidden="true"></i></a> 
                          <?php }?>
                       </td>
                  <?php }?>
