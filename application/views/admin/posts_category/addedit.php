                           ...
                           <?php   $k = 0;foreach($galleryes as $gallery){ $k++; ?>
                              ...
                              <?php   if(!empty($gallery)){  ?> 
                                 ...
                                 <span class="" id="<?=$k.'__gal_image_s'?>">
                                    ...
                                    <a class="cross_image" onclick="delete_image('<?=$k.'__gal_image_s'?>',<?= $record_detail['id'] ?>,'image','assets/images/<?=$url2?>/','<?=$gallery?>','posts_type','<?=$url2?>')">X</a>

                                    <img alt="Personal Styling | StyleBuddy"  alt="StyleBuddy"   class="cross_img" src="<?=trim(base_url().'assets/images/post_category/'.$gallery);?>" alt="">
